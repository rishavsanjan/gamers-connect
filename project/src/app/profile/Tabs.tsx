...
const Tabs: React.FC<Props> = ({ setActiveTab, setGameTab, activeTab, ownedGamesCount, ratingsCount, postsCount, collectionCount, bookmarkCount, followerCountState, followingrCountState, achievementsCount, groupsCount, playlistCount }) => {
    return (
