...
import { fetchRequests } from '@/app/queries/requests'
...
const InfiniteRequests: React.FC<Props> = ({ requests }) => {
    ...
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage } = useInfiniteQuery({
        queryKey: ['follow-requests-recieved', userId],
    ...
    useEffect(() => {
        ...
        const allRequests: Requests[] = data.pages.flatMap(r => r.requests);
        ...
        <>
            {
                <>
                    ...
                    <div ref={lastPostRef} className="h-10 mt-10 flex flex-col justify-center items-center">
                        ...
                        {!hasNextPage  && <p className='text-gray-500 text-lg font-serif'>No more requests</p>}
                    </div>
                </>
            }
