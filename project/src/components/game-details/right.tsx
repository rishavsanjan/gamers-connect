...
const RightSide: React.FC<RightSideProps> = ({ game }) => {
    ...
    return (
        <div className='z-10 md:w-[40%] w-full flex flex-col gap-4 p-8'>
            {
            ...
            <GameImages screenshots={game.screenshots} />
            {
                ...
                <>
                    <span className='text-gray-300 font-medium text-xl'>Where to buy</span>
                    <div className='grid grid-cols-2 gap-4'>
                        {
                            ...
                            game?.websites?.map((store) => {
                                ...
                                if (store.type === 13) {
                                    ...
                                    storeLogo = 'https://img.icons8.com/?size=100&id=XaIQdSh4y3F9&format=png&color=FFFFFF'
                                    storeName = 'Nintendo'
                                } else {
                                    return;
                                }
