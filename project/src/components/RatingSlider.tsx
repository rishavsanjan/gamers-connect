...
interface RatingModelProps {
    ...
    setSharePayload: React.Dispatch<React.SetStateAction<any>>
    setShareAsPost: React.Dispatch<React.SetStateAction<boolean>>
}

const RatingSlider: React.FC<RatingModelProps> = ({ ratingStatus, game, setStatus, setSharePayload, setShareAsPost }) => {
