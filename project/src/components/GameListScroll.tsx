...
const GameListScroll: React.FC<GameProps> = ({ gamesList }) => {
    ...
    return (
        <div
            ref={scrollRef}
            className='flex flex-row overflow-scroll  space-x-4 my-8 hide-scrollbar hover:pb-36 '
                ...
                gamesList?.map((game, index) => {
                    ...
                    return (
                        <div
                            ...
                            key={game.id}
                            className='flex flex-col min-w-[335px] overflow-visible shadow-lg shrink-0 rounded-xl hover:scale-105 duration-300 ease-in-out relative z-10 hover:z-50 py-2 pl-2'
                        >
                            <div>
                                {
                            ...
                            <div className='bg-[#202020] p-2 gap-2 flex flex-col rounded-b-xl '>
                                ...
                                <div className='relative '>
                                    {hoverId === game.id && (
                                        <div className='absolute z-50  bg-[#202020] p-2 rounded-b-xl shadow-2xl min-w-[335px] -left-2 pl-4'>
